...
if [[ -z $url ]]; then
    ...
    full_url="https://www.project.internal:441/$folder/$url"
    export DISPLAY=:0.0
...
EOF
    ...
    mv -v /home/master-desktop04/${folder}.har /home/master-desktop04/Replay/Env${Env}/${folder}_${Delay}_${Loss}_${BW}_Env${Env}_http1_$Latest_task.har
    ./ReplayWebHttp2.sh
