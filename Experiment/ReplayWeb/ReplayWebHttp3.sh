...
if [[ -z $url ]]; then
    ...
    full_url="https://www.project.internal:444/$folder/$url"
    export DISPLAY=:0.0
...
EOF
    ...
    mv -v /home/master-desktop04/${folder}.har /home/master-desktop04/Replay/Env${Env}/${folder}_${Delay}_${Loss}_${BW}_Env${Env}_http3_$Latest_task.har
